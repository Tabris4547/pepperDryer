...
#define PB1_TEMP_SET_UP_Pin GPIO_PIN_1
#define PB1_TEMP_SET_UP_GPIO_Port GPIOB
#define PB1_TEMP_SET_UP_EXTI_IRQn EXTI1_IRQn
#define PB2_TEMP_SET_UP_Pin GPIO_PIN_2
#define PB2_TEMP_SET_UP_GPIO_Port GPIOB
#define PB2_TEMP_SET_UP_EXTI_IRQn EXTI2_IRQn
